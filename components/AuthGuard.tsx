      ...
      <div className="min-h-screen bg-black flex items-center justify-center font-mono">
        <div className="text-center">
          ...
          <div className="mt-4 flex justify-center space-x-1">
            <div className="w-2 h-2 bg-white-400 animate-bounce" style={{ animationDelay: '0ms' }}></div>
            <div className="w-2 h-2 bg-white-400 animate-bounce" style={{ animationDelay: '150ms' }}></div>
            <div className="w-2 h-2 bg-white-400 animate-bounce" style={{ animationDelay: '300ms' }}></div>
          </div>
        </div>
      </div>
    );
